...
from pages.utils import DataCipher
...
class SignUpPage(ft.UserControl):
    ...
    def check_signup_fields(self, e):
        ...
        data_path = 'assets/application_data/application_storage/registered_data.json'
        ...
        if os.path.exists(data_path) and os.path.getsize(data_path) > 0:
            try:
                ...
                print(f"Error checking registration file: {str(ex)}")
